...
import { StyleSheet, View, Modal, Keyboard, Image } from 'react-native';
...
import Rowkatlist from './rowkatlist';
import IklanDetailsView from './detail';

export default class Katlist extends Component {
  constructor() {
    super();
    this.state = {
      iklan: null,
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Rowkatlist rowCat={this.props.rowId} rowMod={this.props.rowMod} onIklanSelected={this._onIklanSelected.bind(this)} />
