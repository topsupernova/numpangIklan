...
import { StyleSheet, View, Text, Image, Keyboard, BackAndroid, Alert, Modal } from 'react-native';
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Searchpagelist rowSrc={this.props.src} onIklanSelected={this._onIklanSelected.bind(this)} />
